...
collection = db.UNIDADRESIDENCIAL
...
class TodoList(Resource):
    ...
    def get(self):
        ...
        for document in cursor:
            ...
            x['UnidadResidencial#' + str(i)] = arreglo
            i+=1
...
api.add_resource(TodoList, '/unidadesResidenciales')  
api.add_resource(Todo, '/unidadesResidenciales/<idP>')
