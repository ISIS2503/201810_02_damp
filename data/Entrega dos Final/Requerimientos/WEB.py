                ...
                if(arreglo[0]== 'yale'):
                   ...
                   if(opcion == 14):
                     ...
                     if (correo == email and clave == password):
                         ...
                         print("Su clave ha sido cambiada")
                         print("")
...
class CambioClave(Resource):
        ...
        def put(self, correo, clave):
            ...
            #json_data = thejson
            json_data = json.loads(thejson)
            print(json_data)
            rol = json_data[0]['Rol']
            nombre = json_data[0]['Nombre']
            password = clave
...
api.add_resource(CambiarClave, '/usuarios/<correo>')
